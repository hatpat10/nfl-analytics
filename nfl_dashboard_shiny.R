...
ui <- fluidPage(
  ...
  tabsetPanel(
    ...
    tabPanel(
      ...
      div(
        class = "info-box",
        h3("Moneyline: Win/Loss Predictions"),
        p("The ML model uses Logistic Regression, Random Forest, and XGBoost to predict which team will WIN each game. Win probability above 60% = recommended bet.")
      ),
      
      h3("🎯 All Moneyline Predictions"),
      DTOutput("ml_predictions_table"),
      
      br(),
      h3("📊 Win Probability Distribution"),
      plotlyOutput("win_prob_chart", height = "500px"),
      
      br(),
      h3("🔥 Strong Moneyline Bets (60%+ Win Probability)"),
    ...
    tabPanel(
      ...
      div(
        class = "info-box",
        h3("Point Spreads: By How Much?"),
        p("The ML model predicts not just WHO wins, but BY HOW MUCH. Spread predictions use EPA differentials and team strength metrics. When the model disagrees with Vegas by 4+ points, that's a value opportunity.")
      ),
      
      h3("📊 All Spread Predictions"),
      DTOutput("spreads_predictions_table"),
      
      br(),
      h3("📈 ML Model Spreads vs Vegas"),
      plotlyOutput("ml_vs_vegas_spreads_chart", height = "500px"),
      
      br(),
      h3("💎 Spread Value Opportunities"),
      p("Games where ML model disagrees with Vegas by 4+ points:"),
      DTOutput("spread_value_bets"),
      
      br(),
      h3("🎯 Biggest Predicted Blowouts"),
      DTOutput("biggest_spreads_table")
    ),
