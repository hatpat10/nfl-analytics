...
# ============================================================================
# AGGREGATE QUARTERBACK STATS WITH PLAYER IDs
# ============================================================================
...
# ============================================================================
# AGGREGATE RUNNING BACK STATS WITH PLAYER IDs
# ============================================================================
...
# ============================================================================
# AGGREGATE RECEIVER STATS WITH PLAYER IDs
# ============================================================================
...
# QB Projections with headshots AND weather
...
# RB Projections with headshots AND weather
...
# WR Projections with headshots AND weather
...
# ============================================================================
# CREATE PLAYER CARDS VISUAL (BONUS)
# ============================================================================
...
create_player_cards <- function(data, stat_col, title, output_file) {
  top_players <- data %>%
    ...
    mutate(
      ...
      weather_label = if_else(!is.na(weather_impact_score) & weather_impact_score > 0,
                              paste0("Weather: ", round(weather_impact_score, 1)),
                              "")
    )
